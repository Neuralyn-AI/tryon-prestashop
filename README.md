...
This PrestaShop module is a connector that integrates the Neuralyn TRYON widget into your store, managed through your Neuralyn account.
...
2. Click the **"Connect with Neuralyn"** button

3. You will be redirected to the Neuralyn platform to complete the setup

4. Once connected, the virtual try-on widget will appear on your product pages

## Account Management

Manage your subscription, view analytics, and configure settings through your Neuralyn dashboard:

**[https://www.neuralyn.com.br/en/login](https://www.neuralyn.com.br/en/login)**
...
Neuralyn TRYON é um sistema de **provador virtual** que permite que seus clientes provem roupas virtualmente antes de comprar. Usando tecnologia avançada de IA, os clientes podem ver como as peças de roupa ficam neles sem sair da sua loja online.

Este módulo PrestaShop é um conector que integra o widget Neuralyn TRYON à sua loja, gerenciado através da sua conta Neuralyn.
...
Basta navegar até qualquer página de produto de roupa e clicar no botão "Prove em você".

## Requisitos

- PrestaShop 1.7 ou superior (compatível com 8.0+)
...
Antes de instalar o módulo, você precisa de uma assinatura ativa do Neuralyn TRYON.

- **Veja todas as funcionalidades:** [https://www.neuralyn.com.br/pt-BR/products/tryon](https://www.neuralyn.com.br/pt/products/tryon)
- **Veja os planos e preços:** [https://www.neuralyn.com.br/pt-BR/pricing/tryon](https://www.neuralyn.com.br/pt-BR/pricing/tryon)

### 2. Baixe e Instale o Módulo
...
3. Clique em **Enviar um módulo** e selecione o arquivo zip baixado

4. O módulo será instalado automaticamente

### 3. Configure o Módulo

1. Após a instalação, clique em **Configurar** no módulo

2. Clique no botão **"Conectar com Neuralyn"**

3. Você será redirecionado para a plataforma Neuralyn para completar a configuração

4. Uma vez conectado, o widget de prova virtual aparecerá nas páginas de produto

## Gerenciamento da Conta

Gerencie sua assinatura, veja análises e configure opções através do seu painel Neuralyn:

**[https://www.neuralyn.com.br/pt-BR/login](https://www.neuralyn.com.br/pt-BR/login)**

## Funcionalidades

A plataforma Neuralyn TRYON oferece:

- Prova virtual com detecção corporal por IA
- Suporte para múltiplas categorias de roupas
- Análises e insights de clientes
- Estilos e posicionamento de botões personalizáveis
...
Este módulo é software proprietário. Cada licença é válida para uma única instalação de loja PrestaShop.
