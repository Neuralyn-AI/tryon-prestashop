...
<div class="neuralyn-tryon-hook-container">
    <button
            class="neuralyn-tryon-app-button neuralyn-tryon-app-button-default is-visible"
            style="display: none">
            <svg fill="currentColor" version="1.0" xmlns="http://www.w3.org/2000/svg" width="15.000000pt"
              height="15.000000pt" viewBox="0 0 50.000000 45.000000" preserveAspectRatio="xMidYMid meet">
